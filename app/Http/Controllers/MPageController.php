...
class MPageController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if($summary->type === "SECTION"){
            $page->heading = $summary->heading;
        }else{
            $page->title = $summary->title;
            $page->slug = $summary->slug;
            $page->meta_keyword = $summary->meta_keyword;
            $page->meta_description = $summary->meta_description;

        }

        $page->description = $summary->description; 
        $page->status = $summary->status; 
        $page->created_id = Auth::id(); 
        $page->updated_id = Auth::id(); 
    ...
    public function datatable(Request $request)
    {
        ...
        $search_column = array(
            ...
            "heading" => (isset($columns[3]['search']['value'])) ? $columns[3]['search']['value'] : "",
            "type" => (isset($columns[4]['search']['value'])) ? $columns[4]['search']['value'] : "",
            "title" => (isset($columns[5]['search']['value'])) ? $columns[5]['search']['value'] : "",
            "slug" => (isset($columns[6]['search']['value'])) ? $columns[6]['search']['value'] : "",
            "meta_keyword" => (isset($columns[7]['search']['value'])) ? $columns[7]['search']['value'] : "",
            "meta_description" => (isset($columns[8]['search']['value'])) ? $columns[8]['search']['value'] : "",
            "status" => (isset($columns[9]['search']['value'])) ? $columns[9]['search']['value'] : "",
        ...
        if ($order_index == 1)
            ...
            $order_field = 'meta_keyword';
        else if ($order_index == 8)
            $order_field = 'meta_description';
        ...
        foreach ($filter_data as $value) {
            ...
            $row[] = $value->title;
            $row[] = $value->slug;
            $row[] = $value->meta_keyword;
            $row[] = $value->meta_description;
