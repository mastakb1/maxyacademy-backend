                    ...
                    <div class="col-md-12">
                        <section class="panel">
                            <header class="panel-heading">
                                ...
                                else echo 'Ubah'; ?> Package
                            </header>
                            <div class="panel-body" id="toro-area">
                                <form id="toro-form" method="POST" action="{{ ($data['actions'] == 'store') ? route('packages.store') : route('packages.update', base64_encode($data['package']->id)) }}">
...
<script>
    ...
    function PackageViewModel() {
        ...
        self.name = ko.observable('<?php if (isset($data['package'])) echo $data['package']->name ?>');
        self.description = ko.observable('<?php if (isset($data['package'])) echo $data['package']->description ?>');
        self.price = ko.observable('<?php if (isset($data['package'])) echo $data['package']->price ?>');
        self.status = ko.observable(<?= (isset($data['package'])) ? (($data['package']->status == 1) ? 'true' : 'false') : 'true' ?>);
