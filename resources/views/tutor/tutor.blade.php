                    ...
                    <div class="col-md-12">
                        <section class="panel">
                            <header class="panel-heading">
                                ...
                                else echo 'Ubah'; ?> Tutor
                            </header>
                            <div class="panel-body" id="toro-area">
                                <form id="toro-form" method="POST" action="{{ ($data['actions'] == 'store') ? route('tutors.store') : route('tutors.update', base64_encode($data['tutor']->id)) }}" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <div class="main-img-preview">
                                                <?php if (isset($data['tutor'])) : ?>
                                                    <?php if ($data['tutor']->profile_picture != NULL) : ?>
                                                        <img id="preview" name="preview" class="thumbnail img-preview" src="{{asset('uploads/tutor/' . $data['tutor']->profile_picture)}}" title="Preview Profile Picture">
                                                    <?php else : ?>
                                            ...
                                            <input type="file" name="profile" id="profile" class="form-control" onchange="img_preview(this, 'preview')">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" id="role" name="role" placeholder="Enter role" data-bind="value: role" required>
                                        </div>
                                    </div>
                                    <div class="form-group row">
...
<script>
    ...
    function TutorViewModel() {
        ...
        self.availableCompany = ko.observableArray(<?php if (isset($data['company'])) echo $data['company'] ?>);
    ...
    ko.applyBindings(new TutorViewModel());
</script>
@endsection