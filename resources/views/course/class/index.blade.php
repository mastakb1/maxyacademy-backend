                    ...
                    <div class="col-md-12">
                        <section class="panel">
                            ...
                            <div class="panel-body" id="toro-area">
                                @can('access','course_class_create')
                                <a class="btn btn-info" href="{{ route('course_classes.create', $data['id_course']) }}">Tambah Course Class</a>
                                @endcan
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        tabel = $('#toro-data').DataTable({
            ...
            "ajax": {
                "url": "{{ route('course_classes.datatable', base64_decode($data['id_course'])) }}",
                "type": "GET",
            },
            "deferRender": true,
            "columnDefs": [{
