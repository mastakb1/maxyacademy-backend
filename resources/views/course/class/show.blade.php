                    ...
                    <div class="col-md-12">
                        <section class="panel">
                            ...
                            <div class="panel-body" id="toro-area">
                                    ...
                                    <div class="content">
                                        <div class="description">
                                            ...
                                            <div class="row" style="margin-bottom: 5px;">
                                                ...
                                                <div class="col-sm-10">
                                                    {{ date('d F Y', strtotime($data['course_class']->start_date)) }}
                                                </div>
                                            </div>
                                            <div class="row" style="margin-bottom: 5px;">
                                                <div class="col-sm-2">
                                                ...
                                                <div class="col-sm-10">
                                                    {{ date('d F Y', strtotime($data['course_class']->end_date)) }}
                                                </div>
                                            </div>
                                            <div class="row" style="margin-bottom: 5px;">
                                                <div class="col-sm-2">
                                                ...
                                                <div class="col-sm-10">
                                                    {{ $data['course_class']->quota == 0 ? 'Unlimited' : $data['course_class']->quota }}
                                                </div>
                                            </div>
                                            <div class="row" style="margin-bottom: 5px;">
                                                <div class="col-sm-2">
                                                ...
                                                <div class="col-sm-10">
                                                    {{ $data['course_class']->status == 1 ? 'Aktif' : 'Tidak Aktif' }}
                                                </div>
                                            </div>
                                            <div class="row" style="margin-bottom: 5px;">
                                                <div class="col-sm-2">
                                                ...
                                                <div class="col-sm-10">
                                                    {{ date('d-m-Y H:i:s', strtotime($data['course_class']->created_at)) }}
                                                </div>
                                            </div>
                                            <div class="row" style="margin-bottom: 5px;">
                                                <div class="col-sm-2">
                                                ...
                                                <div class="col-sm-10">
                                                    {{ $data['course_class']->user_create->name }}
                                                </div>
                                            </div>
                                            <div class="row" style="margin-bottom: 5px;">
                                                <div class="col-sm-2">
                                                ...
                                                <div class="col-sm-10">
                                                    {{ date('d-m-Y H:i:s', strtotime($data['course_class']->updated_at)) }}
                                                </div>
                                            </div>
                                            <div class="row" style="margin-bottom: 5px;">
                                                <div class="col-sm-2">
                                                ...
                                                <div class="col-sm-10">
                                                    {{ $data['course_class']->user_update->name }}
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="content">
                                        <div class="description">
                                            <div class="ui one statistics">
                                                <div class="statistic">
                                                    <div class="value">
                                                        {{ $data['course_class_member']->count() }}
                                                    </div>
                                                    <div class="label">
                                                        Total Member
                                                    </div>
                                ...
                                <div class="ui card" style="width: 100%;">
                                    <div class="content">
                                        <div class="header">Course Class Member</div>
                                    </div>
                                    <div class="content">
                                        <div class="description">
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        datatable('#btnbar', '#toro-data', '#toro-data tfoot th', <?= $data['course_class_member'] ?>, [{
            data: 'id_member',
            render: function(value) {
                return "<a class='btn btn-success btn-xl' href='<?= url('members') . '/' ?>" + btoa(value) + "'><i class='fa fa-fw fa-eye'></i> Detail</a>";
            }
        }, {
            data: 'id'
        }, {
