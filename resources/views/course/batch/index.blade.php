                    ...
                    <div class="col-md-12">
                        <section class="panel">
                            ...
                            <div class="panel-body" id="toro-area">
                                @can('access','course_batch_create')
                                <a class="btn btn-info" href="{{ route('course_batches.create', $data['id_m_course']) }}">Tambah Course Batch</a>
                                @endcan
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        tabel = $('#toro-data').DataTable({
            ...
            "ajax": {
                "url": "{{ route('course_batches.datatable', base64_decode($data['id_m_course'])) }}",
                "type": "GET",
            },
            "deferRender": true,
            "columnDefs": [{
