                    ...
                    <div class="col-md-12">
                        <section class="panel">
                            <header class="panel-heading">
                                Daftar Course Module Child
                            </header>
                            <div class="panel-body" id="toro-area">
                                @can('access','course_module_child_create')
                                <a class="btn btn-info" href="{{ route('course_module_childs.create', $data['id_course_module']) }}">Tambah Child</a>
                                @endcan
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        tabel = $('#toro-data').DataTable({
            ...
            "ajax": {
                "url": "{{ route('course_module_childs.datatable', base64_decode($data['id_course_module'])) }}",
                "type": "GET",
            },
            "deferRender": true,
            "columnDefs": [{
