                    ...
                    <div class="col-md-12">
                        <section class="panel">
                            <header class="panel-heading">
                                Daftar Course Module
                            </header>
                            <div class="panel-body" id="toro-area">
                                @can('access','course_module_create')
                                <a class="btn btn-info" href="{{ route('course_modules.create') }}">Tambah Course Module</a>
                                @endcan
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        tabel = $('#toro-data').DataTable({
            ...
            "ajax": {
                "url": "{{ route('course_modules.datatable') }}",
                "type": "GET",
            },
            "deferRender": true,
            "columnDefs": [{
