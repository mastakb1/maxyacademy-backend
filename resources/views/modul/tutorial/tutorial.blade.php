                    ...
                    <div class="col-md-12">
                        <section class="panel">
                            <header class="panel-heading">
                                ...
                                else echo 'Ubah'; ?> Modul Tutorial
                            </header>
                            <div class="panel-body" id="toro-area">
                                <form id="toro-form" method="POST" action="{{ ($data['actions'] == 'store') ? route('modul_tutorials.store', $data['id_m_modul']) : route('modul_tutorials.update', ['id' => $data['id_m_modul'], 'id_tutorial' => base64_encode($data['modul_tutorial']->id)]) }}">
...
<script>
    ...
    function ModulTutorialViewModel() {
        var self = this;

        self.name = ko.observable('<?php if (isset($data['modul_tutorial'])) echo $data['modul_tutorial']->name ?>');
        self.description = ko.observable('<?php if (isset($data['modul_tutorial'])) echo $data['modul_tutorial']->description ?>');
        self.status = ko.observable(<?= (isset($data['modul_tutorial'])) ? (($data['modul_tutorial']->status == 1) ? 'true' : 'false') : 'true' ?>);
    }

    ko.applyBindings(new ModulTutorialViewModel());
</script>
@endsection