...
@section('title', 'Modul Tutorial Detail')
@section('content')
<?php
                    ...
                    <div class="col-md-12">
                        <section class="panel">
                            ...
                            <div class="panel-body" id="toro-area">
                                    ...
                                    <div class="content">
                                        <div class="description">
                                            ...
                                            <div class="row" style="margin-bottom: 5px;">
                                                ...
                                                <div class="col-sm-10">
                                                    {{ $data['modul_tutorial']->status == 1 ? 'Aktif' : 'Tidak Aktif' }}
                                                </div>
                                            </div>
                                            <div class="row" style="margin-bottom: 5px;">
                                                <div class="col-sm-2">
                                                ...
                                                <div class="col-sm-10">
                                                    {{ date('d-m-Y H:i:s', strtotime($data['modul_tutorial']->created_at)) }}
                                                </div>
                                            </div>
                                            <div class="row" style="margin-bottom: 5px;">
                                                <div class="col-sm-2">
                                                ...
                                                <div class="col-sm-10">
                                                    {{ $data['modul_tutorial']->user_create->name }}
                                                </div>
                                            </div>
                                            <div class="row" style="margin-bottom: 5px;">
                                                <div class="col-sm-2">
                                                ...
                                                <div class="col-sm-10">
                                                    {{ date('d-m-Y H:i:s', strtotime($data['modul_tutorial']->updated_at)) }}
                                                </div>
                                            </div>
                                            <div class="row" style="margin-bottom: 5px;">
                                                <div class="col-sm-2">
                                                ...
                                                <div class="col-sm-10">
                                                    {{ $data['modul_tutorial']->user_update->name }}
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="ui card" style="width: 100%;">
                                    <div class="content">
                                        <div class="header">View Tutorial</div>
                                    </div>
                                    <div class="content">
                                        <div class="description">
                                            <iframe srcdoc="<?= $data['modul_tutorial']->description ?>" frameborder="0"></iframe>
                                        </div>
                                    </div>
                                </div>
                            </div>
