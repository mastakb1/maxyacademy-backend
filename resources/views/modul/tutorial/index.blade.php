                    ...
                    <div class="col-md-12">
                        <section class="panel">
                            ...
                            <div class="panel-body" id="toro-area">
                                @can('access','modul_tutorial_create')
                                <a class="btn btn-info" href="{{ route('modul_tutorials.create', $data['id_m_modul']) }}">Tambah Modul Tutorial</a>
                                @endcan
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        tabel = $('#toro-data').DataTable({
            ...
            "ajax": {
                "url": "{{ route('modul_tutorials.datatable', base64_decode($data['id_m_modul'])) }}",
                "type": "GET",
            },
            "deferRender": true,
            "columnDefs": [{
