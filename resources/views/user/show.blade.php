                                    ...
                                    <div class="content">
                                        <div class="description">
                                            <div class="row" style="margin-bottom: 5px;">
                                                ...
                                                <div class="col-sm-10">{{ $data['user']->name }}</div>
                                            </div>
                                            <div class="row" style="margin-bottom: 5px;">
                                                <div class="col-sm-2"><b>Email :</b></div>
                                                <div class="col-sm-10">{{ $data['user']->email }}</div>
                                            </div>
                                            <div class="row" style="margin-bottom: 5px;">
                                                <div class="col-sm-2"><b>Access Group :</b></div>
                                                <div class="col-sm-10">{{ $data['user']->access_group->name }}</div>
                                            </div>
                                            <div class="row" style="margin-bottom: 5px;">
                                                <div class="col-sm-2"><b>Created At :</b></div>
                                                <div class="col-sm-10">{{ date('d-m-Y H:i:s', strtotime($data['user']->created_at)) }}</div>
                                            </div>
                                            <div class="row" style="margin-bottom: 5px;">
                                                <div class="col-sm-2"><b>Updated At :</b></div>
                                                <div class="col-sm-10">{{ date('d-m-Y H:i:s', strtotime($data['user']->updated_at)) }}</div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
