                    ...
                    <div class="col-md-12">
                        <section class="panel">
                            <header class="panel-heading">
                                Daftar Content Carousel
                            </header>
                            <div class="panel-body" id="toro-area">
                                @can('access','m_content_carousel_create')
                                <a class="btn btn-info" href="{{ route('content_carousels.create') }}">Tambah Content</a>
                                @endcan
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        tabel = $('#toro-data').DataTable({
            ...
            "ajax": {
                "url": "{{ route('content_carousels.datatable') }}",
                "type": "GET",
            },
            "deferRender": true,
            "columnDefs": [{
