...
<script>
    ...
    function SubjectViewModel() {
        ...
        self.name = ko.observable('<?php if (isset($data['access_master'])) echo $data['access_master']->name ?>');
        self.description = ko.observable('<?php if (isset($data['access_master'])) echo $data['access_master']->description ?>');
    }
