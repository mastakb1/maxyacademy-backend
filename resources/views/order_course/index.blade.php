                    ...
                    <div class="col-md-12">
                        <section class="panel">
                            ...
                            <div class="panel-body" id="toro-area">
                                ...
                                @endif
                                @can('access','order_course_create')
                                <a class="btn btn-info" href="{{ route('order_courses.create') }}">Tambah Order Course</a>
                                @endcan
            ...
            <div class="modal-body">
                <div id='content' class="tab-content">
                    <div class="tab-pane active" id="uplod">
                        <form action="{{ route('order_courses.forced') }}" method="POST" id="form_complete">
                            @csrf
                            <input type="hidden" name="id" id="id_order_complete">
                            <input type="hidden" name="action" value="COMPLETE">
                            <div class="form-group row">
                                <label for="forced_comment" class="col-sm-2 col-form-label">Alasan Complete</label>
                                <div class="col-sm-10">
                                    <textarea class="textarea form-control" rows="8" id="forced_comment" name="forced_comment"></textarea>
                                </div>
                            </div>
                            <div class="form-group row">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div id='content' class="tab-content">
                    <div class="tab-pane active" id="uplod">
                        <form action="{{ route('order_courses.forced') }}" method="POST" id="form_cancel">
                            @csrf
                            <input type="hidden" name="id" id="id_order_cancel">
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        $('#toro-data').on('click', '#modal_cancel', function(e) {
            ...
            $('#id_order_cancel').val(btoa(id));
        });

        $('#toro-data').on('click', '#modal_complete', function(e) {
            var id = $(e.currentTarget).data('order');
            $('#id_order_complete').val(btoa(id));
        });
        ...
        tabel = $('#toro-data').DataTable({
            ...
            "ajax": {
                "url": "{{ route('order_courses.datatable') }}",
                "type": "GET",
            },
            "deferRender": true,
            "columnDefs": [{
