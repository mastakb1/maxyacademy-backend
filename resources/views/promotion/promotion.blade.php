                    ...
                    <div class="col-md-12">
                        <section class="panel">
                            <header class="panel-heading">
                                ...
                                else echo 'Ubah'; ?> Promotion
                            </header>
                            <div class="panel-body" id="toro-area">
                                <form id="toro-form" method="POST" action="{{ ($data['actions'] == 'store') ? route('promotions.store') : route('promotions.update', base64_encode($data['promotion']->id)) }}">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <select class="form-control" id="course" name="course" required data-bind="selectedOptions: id_course,valueAllowUnset: true, options: $root.availableCourse, 
...
<script>
    ...
    function DiscountViewModel() {
        ...
        self.name = ko.observable('<?php if (isset($data['promotion'])) echo $data['promotion']->name ?>');
        self.code = ko.observable('<?php if (isset($data['promotion'])) echo $data['promotion']->code ?>');
        self.description = ko.observable('<?php if (isset($data['promotion'])) echo $data['promotion']->description ?>');
        self.discount_type = ko.observable('<?php if (isset($data['promotion'])) echo $data['promotion']->discount_type ?>');
        self.discount = ko.observable('<?php if (isset($data['promotion'])) echo $data['promotion']->discount ?>');
        self.max_discount = ko.observable('<?php if (isset($data['promotion'])) echo $data['promotion']->max_discount ?>');
        self.id_course = ko.observableArray(<?php if (isset($data['course_discount'])) echo $data['course_discount'] ?>);
        ...
        dateRange('date', self.date, '<?php if (isset($data['promotion'])) echo $data['promotion']->start_date ?>', '<?php if (isset($data['promotion'])) echo $data['promotion']->end_date ?>');
    }
