                    ...
                    <div class="col-md-12">
                        <section class="panel">
                            ...
                            <div class="panel-body" id="toro-area">
                                    ...
                                    <div class="content">
                                        <div class="description">
                                            ...
                                            <div class="row" style="margin-bottom: 5px;">
                                                ...
                                                <div class="col-sm-10">
                                                    {{ date('d F Y H:i:s', strtotime($data['promotion']->start_date)) . ' - ' . date('d F Y H:i:s', strtotime($data['promotion']->end_date)) }}
                                                </div>
                                            </div>
                                            <div class="row" style="margin-bottom: 5px;">
                                                <div class="col-sm-2">
                                                ...
                                                <div class="col-sm-10">
                                                    <?php echo $data['promotion']->description ?>
                                                </div>
                                            </div>
                                            <div class="row" style="margin-bottom: 5px;">
                                                <div class="col-sm-2">
                                            ...
                                            <div class="row" style="margin-bottom: 5px;">
                                                ...
                                                <div class="col-sm-10">
                                                    {{ $data['promotion']->status == 1 ? 'Aktif' : 'Tidak Aktif' }}
                                                </div>
                                            </div>
                                            <div class="row" style="margin-bottom: 5px;">
                                                <div class="col-sm-2">
                                                ...
                                                <div class="col-sm-10">
                                                    {{ date('d-m-Y H:i:s', strtotime($data['promotion']->created_at)) }}
                                                </div>
                                            </div>
                                            <div class="row" style="margin-bottom: 5px;">
                                                <div class="col-sm-2">
                                                ...
                                                <div class="col-sm-10">
                                                    {{ $data['promotion']->user_create->name }}
                                                </div>
                                            </div>
                                            <div class="row" style="margin-bottom: 5px;">
                                                <div class="col-sm-2">
                                                ...
                                                <div class="col-sm-10">
                                                    {{ date('d-m-Y H:i:s', strtotime($data['promotion']->updated_at)) }}
                                                </div>
                                            </div>
                                            <div class="row" style="margin-bottom: 5px;">
                                                <div class="col-sm-2">
                                                ...
                                                <div class="col-sm-10">
                                                    {{ $data['promotion']->user_update->name }}
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="content">
                                        <div class="description">
                                            <div class="ui two statistics">
                                                ...
                                                <div class="statistic">
                                                    <div class="value">
                                                        {{ number_format($data['promotion']->orders->sum('discount'), 0, ',', '.') }}
                                                    </div>
                                                    <div class="label">
                                                        Total Discount
                                                    </div>
                                ...
                                <div class="ui card" style="width: 100%;">
                                    <div class="content">
                                        <div class="header">Used History</div>
                                    </div>
                                    <div class="content">
                                        <div class="description">
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        datatable('#btnbar', '#toro-data', '#toro-data tfoot th', <?= $data['promotion']->orders ?>, [{
            data: 'id',
            render: function(value) {
                return "<a class='btn btn-success btn-xl' href='<?= url('orders') . '/' ?>" + btoa(value) + "'><i class='fa fa-fw fa-eye'></i> Detail</a>";
            }
        }, {
            data: 'date',
            render: function(value) {
