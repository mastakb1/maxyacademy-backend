                    ...
                    <div class="col-md-12">
                        <section class="panel">
                            <header class="panel-heading">
                                Daftar Difficulty Type
                            </header>
                            <div class="panel-body" id="toro-area">
                                @can('access','m_difficulty_type_create')
                                <a class="btn btn-info" href="{{ route('difficulty_types.create') }}">Tambah Difficulty Type</a>
                                @endcan
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        tabel = $('#toro-data').DataTable({
            ...
            "ajax": {
                "url": "{{ route('difficulty_types.datatable') }}",
                "type": "GET",
            },
            "deferRender": true,
            "columnDefs": [{
