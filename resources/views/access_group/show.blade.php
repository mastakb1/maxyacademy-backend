                                    ...
                                    <div class="content">
                                        <div class="description">
                                            <div class="row" style="margin-bottom: 5px;">
                                                ...
                                                <div class="col-sm-10">{{ $data['access_group']->name }}</div>
                                            </div>
                                            <div class="row" style="margin-bottom: 5px;">
                                                <div class="col-sm-2"><b>Keterangan :</b></div>
                                                <div class="col-sm-10"><?php echo $data['access_group']->description ?></div>
                                            </div>
                                            <div class="row" style="margin-bottom: 5px;">
                                                <div class="col-sm-2"><b>Created At :</b></div>
                                                <div class="col-sm-10">{{ date('d-m-Y H:i:s', strtotime($data['access_group']->created_at)) }}</div>
                                            </div>
                                            <div class="row" style="margin-bottom: 5px;">
                                                <div class="col-sm-2"><b>Created By :</b></div>
                                                <div class="col-sm-10">{{ $data['access_group']->user_create->name }}</div>
                                            </div>
                                            <div class="row" style="margin-bottom: 5px;">
                                                <div class="col-sm-2"><b>Updated At :</b></div>
                                                <div class="col-sm-10">{{ date('d-m-Y H:i:s', strtotime($data['access_group']->updated_at)) }}</div>
                                            </div>
                                            <div class="row" style="margin-bottom: 5px;">
                                                <div class="col-sm-2"><b>Updated By :</b></div>
                                                <div class="col-sm-10">{{ $data['access_group']->user_update->name }}</div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        datatable('#btnbar', '#toro-data', '#toro-data tfoot th', <?= $data['access_group']->access_masters ?>, [{
            data: 'id',
        ...
        datatable('#btnbar2', '#toro-data2', '#toro-data2 tfoot th', <?= $data['access_group']->users ?>, [{
                data: 'id',
                render: function(value) {
