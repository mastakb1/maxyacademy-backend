                    ...
                    <div class="col-md-12">
                        <section class="panel">
                            ...
                            <div class="panel-body" id="toro-area">
                                <form id="toro-form" method="POST" action="{{ ($data['actions'] == 'store') ? route('banks.store') : route('banks.update', base64_encode($data['bank']->id)) }}">
...
<script>
    ...
    function BankViewModel() {
        ...
        self.name = ko.observable('<?php if (isset($data['bank'])) echo $data['bank']->name ?>');
        self.code = ko.observable('<?php if (isset($data['bank'])) echo $data['bank']->code ?>');
        self.description = ko.observable('<?php if (isset($data['bank'])) echo $data['bank']->description ?>');
        self.status = ko.observable(<?= (isset($data['bank'])) ? (($data['bank']->status == 1) ? 'true' : 'false') : 'true' ?>);
    }
