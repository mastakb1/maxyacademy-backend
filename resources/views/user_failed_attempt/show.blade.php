...
@section('title', 'User Failed Attempt Detail')
@section('content')
<?php
                                    ...
                                    <div class="content">
                                        <div class="description">
                                            <div class="row" style="margin-bottom: 5px;">
                                                ...
                                                <div class="col-sm-10">
                                                    {{ $data['users_failed_attempts']->email }}
                                                </div>
                                            </div>
                                            <div class="row" style="margin-bottom: 5px;">
                                                <div class="col-sm-2">
                                            ...
                                            <div class="row" style="margin-bottom: 5px;">
                                                ...
                                                <div class="col-sm-10">
                                                    {{ date('d-m-Y H:i:s', strtotime($data['users_failed_attempts']->created_at)) }}
                                                </div>
                                            </div>
                                        </div>
                                    </div>
