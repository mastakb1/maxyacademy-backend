                    ...
                    <div class="col-md-12">
                        <section class="panel">
                            ...
                            <div class="panel-body" id="toro-area">
                                ...
                                @endif
                                @can('access','trans_order_create')
                                <a class="btn btn-info" href="{{ route('orders.create') }}">Tambah Order Course</a>
                                @endcan
            ...
            <div class="modal-body">
                <div id='content' class="tab-content">
                    <div class="tab-pane active" id="uplod">
                        <form action="{{ route('orders.forced') }}" method="POST" id="form_complete">
                            @csrf
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div id='content' class="tab-content">
                    <div class="tab-pane active" id="uplod">
                        <form action="{{ route('orders.forced') }}" method="POST" id="form_cancel">
                            @csrf
