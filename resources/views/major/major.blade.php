                    ...
                    <div class="col-md-12">
                        <section class="panel">
                            <header class="panel-heading">
                                ...
                                else echo 'Ubah'; ?> Major
                            </header>
                            <div class="panel-body" id="toro-area">
                                <form id="toro-form" method="POST" action="{{ ($data['actions'] == 'store') ? route('majors.store') : route('majors.update', base64_encode($data['major']->id)) }}">
...
<script>
    ...
    function MajorViewModel() {
        ...
        self.name = ko.observable('<?php if (isset($data['major'])) echo $data['major']->name ?>');
        self.description = ko.observable('<?php if (isset($data['major'])) echo $data['major']->description ?>');
        self.status = ko.observable(<?= (isset($data['major'])) ? (($data['major']->status == 1) ? 'true' : 'false') : 'true' ?>);
    }

    ko.applyBindings(new MajorViewModel());
</script>
@endsection